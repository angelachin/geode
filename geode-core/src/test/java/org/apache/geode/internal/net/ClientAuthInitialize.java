...
public class ClientAuthInitialize implements AuthInitialize {
  ...
  public Properties getCredentials(Properties securityProps, DistributedMember server,
    ...
    if(username == null) {
      throw new AuthenticationFailedException("unable to find "+ SECURITY_USERNAME + " [gfsecurity.properties]");
    }
    if(password == null) {
      throw new AuthenticationFailedException("unable to find "+ SECURITY_PASSWORD + " [gfsecurity.properties]");
    }
